...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/25 03:19:38 by aaouassa          #+#    #+#             */
/*   Updated: 2023/06/25 11:38:28 by aaouassa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						ft_transfer_command(t_command *command,
							int i, t_commnd *cmd);
void					ft_transfer_arg(t_argument *argument,
							t_red *red, t_commnd *cmd, int i);
/*      Exec Part            */
